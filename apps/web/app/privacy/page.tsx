      ...
      <main className="shell section-anchor max-w-3xl py-24" id="main">
        ...
        <div className="mt-8 grid gap-5 text-muted">
          <p>
            ...
            assistance is scoped to the table session. The basic assist flow
            does not require guest name, email, or payment details.
          </p>
          <p>
            Restaurant operations data is tenant-scoped to the organisation
            that owns the venue. Display devices use revocable tokens.
          </p>
          <p>
